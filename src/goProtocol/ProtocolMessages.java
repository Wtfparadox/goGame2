...
public class ProtocolMessages {
	...
	public static final char HANDSHAKE = 'H'; // From client and back again from the server to check whether they both
	...
	public static final char WHITE = 'W'; // From either player (to indicate preferred color) or server (to indicate
											// assigned color)
	// also used in the string representation of the board
	public static final char BLACK = 'B'; // From either player (to indicate preferred color) or server (to indicate
											// assigned color)
	// also used in the string representation of the board
